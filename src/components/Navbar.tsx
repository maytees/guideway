...
const Navbar = () => {
    ...
    return (
        <>
            <header className="pb-10 z-50 top-0 flex h-16 items-center gap-4 md:px-6 mt-10 pt-10">
                <nav className="hidden container md:flex flex-row md:items-center md:justify-between gap-24 md:px-14 lg:px-32 w-full ">
