...
import { type ILogin, loginSchema, type IRegister, registerSchema, type IGoogleName, goolgeNameSchema, IForgotPassword, forgotPasswordSchema, IPasswordReset, passwordResetSchema } from "~/lib/validation";
